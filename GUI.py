...
button9 = tk.Button(window, text="Delete Folder Contents", command=delete_folder_contents, width=20, height=2, bd=0, bg="#E0E0E0", relief="solid", borderwidth=1, highlightthickness=0, padx=10, pady=10, font=("Helvetica", 12), border=0, highlightcolor="#FFFFFF", highlightbackground="#FFFFFF", activebackground="#BDBDBD", activeforeground="#FFFFFF")
